            ...
            <div className="relative flex flex-col justify-center items-start gap-3">
              <div className="relative w-full">
                <input
                  ...
                  className="w-full rounded-md bg-gray-50 h-10 pl-4 pr-8 border focus:outline-none focus:outline-white"
                  required
                />
              ...
              <div className="relative w-full">
                <input
                  ...
                  autoComplete="email"
                />
                <MdOutlineMail className="absolute top-3 transform-translate-y-1/2 right-3 text-gray-600" />
              </div>
              <div className="relative w-full">
                <input
                ...
                {ispasswordVisible ? (
                  <FaEyeSlash
                    className="absolute top-3 transform-translate-y-1/2 right-3 text-gray-600 cursor-pointer"
                    onClick={Toggle}
                  />
                ) : (
                  <FaEye
              ...
              <div className="flex gap-2">
                ...
                />
                <label className="text-sm underline text-blue-500 cursor-pointer">
